...
def test_main_json(mock_load_transactions_data: Mock, operations_list: list[dict], monkeypatch: MonkeyPatch,
...
def test_main_csv(mock_load_transactions_data_csv: Mock, operations_list: list[dict], monkeypatch: MonkeyPatch,
                  capsys: CaptureFixture[str]) -> None:
...
def test_main_xlsx(mock_load_transactions_data_xlsx: Mock, operations_list: list[dict], monkeypatch: MonkeyPatch,
                   capsys: CaptureFixture[str]) -> None:
