...
def sort_by_date(operations_list: list[dict], reverse_sorting: bool = False) -> list[dict]:
    """function for sorting operations list by date"""
    return sorted(operations_list, key=lambda operation: operation.get('date'), reverse=reverse_sorting)
